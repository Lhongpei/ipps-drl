...
class CaseGenerator:
    ...
    '''
    def __init__(self, job_num=5, machine_num=15):
        self.job_num = job_num
        self.machine_num = machine_num


    def get_case(self,save=False,new_folder=None,mas_p=0.5,or_p=0.3,ope=True,ope_num=10, ope_range=(5,20),total_ope_range=(5,100),time_range=(5,50),max_out=2,road_num=3, ope_num_orpath=3,and_road_num=3,ope_num_andpath=3,and_p=0.3,path=None):
    ...
    def get_case_file(self,job_folder,save=False,new_folder=None):
        '''
        ...
        while True:
            ...
            # print(f'Total job files in folder {job_folder}:', len(job_files))
            # 确保文件按升序排列
            job_files.sort()
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(2000)):
        job_num=10#int(i/500)+2
        machine_num=16#random.randint(4,10)
        case_generator = CaseGenerator(job_num,machine_num)
        lines = case_generator.get_case_file('problem_generate/0808jobs/mas16',save=True,new_folder=f'problem_generate/0808problem/or_problem_job{job_num}_mas{machine_num}')
