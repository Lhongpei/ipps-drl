...
from ipps_drl.env.load_data import load_ipps
from ipps_drl.utils.get_possible_set import read_ipps_data, get_comb_info
import os
import pandas as pd
import time
import re
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_folder', default='data/test/0405/solution', help='Save folder path')
